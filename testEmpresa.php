...
$objCliente1 = new Cliente('Ignacio', 'Rodriguez', false, 'dni', 39876543);
$objCliente2 = new Cliente('Federico', 'Fernandez', true, 'dni', 30123456);

$objMoto1 = new Moto(11, 2230000, 2022, 'Benelli Imperiale 400', 85, true);
$objMoto2 = new Moto(12, 584000, 2021, 'Zanella Zr 150 Ohc', 70, true);
$objMoto3 = new Moto(13, 999900, 2023, 'Zanella Patagonian Eagle 250', 55, false);

$objEmpresa1 = new Empresa("Alta Gama", "Avenida Argentina 123", [$objMoto1, $objMoto2, $objMoto3], [$objCliente1, $objCliente2], []);
...
retornarVentasXCliente("dni", 39876543);

retornarVentasXCliente("dni", 30123456);
