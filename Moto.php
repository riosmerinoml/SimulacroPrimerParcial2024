...
class Moto {
    ...
    public function __construct($codigoMotoParam, $costoMotoParam, $anioMotoParam,
         $descripcionMotoParam, $porcentajeIncrementoAnualMotoParam, $activaParam) {
            $this->codigoMoto=$codigoMotoParam;
            $this->costoMoto=$costoMotoParam;
            $this->anioMoto=$anioMotoParam;
            $this->descripcionMoto=$descripcionMotoParam;
            $this->porcentajeIncrementoAnualMoto=$porcentajeIncrementoAnualMotoParam;
    ...
    /**
     * Get the value of anioMoto
     */ 
    public function getAnioMoto()
    {
        return $this->anioMoto;
    }

    /**
     * Set the value of anioMoto
     *
     * @return  self
     */ 
    public function setAnioMoto($anioMoto)
    {
    ...
    public function __toString() {
        $cadena = "\nCodigoMoto: ".$this->getCodigoMoto().
                    "\nCosto Moto: ".$this->getCostoMoto().
                    "\nAño Moto: ".$this->getAnioMoto().
                    "\nDescripción: ".$this->getDescripcionMoto().
                    "\nPorcentaje Incremento Anual Moto: ".$this->getPorcentajeIncrementoAnualMoto().
    ...
    public function darPrecioVenta() {
        $aniosTranscurridos = 2024 - $this->getAnioMoto();

        $venta = $this->getCostoMoto() + $this->getCostoMoto() * ($aniosTranscurridos * ($this->getPorcentajeIncrementoAnualMoto()*0.01));
        return $venta;
    }
