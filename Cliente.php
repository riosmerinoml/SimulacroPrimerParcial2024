...
class Cliente {
    ...
    public function __construct($nombreClienteParam, $apellidoClienteParam, $bajaParam, $tipoDocumentoParam, $numDocumentoParam){
        $this->nombreCliente = $nombreClienteParam;
        $this->apellidoCliente = $apellidoClienteParam;
        $this->baja = $bajaParam;
        $this->tipoDocumento = $tipoDocumentoParam;
        $this->numDocumento = $numDocumentoParam;
    }   
